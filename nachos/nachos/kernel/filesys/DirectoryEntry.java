...
class DirectoryEntry {
    ...
    /***
     * If the directoryFlag is 1, this means it is an directory
     * If the directoryFlag is 2, this means it is a file
     */
	...
	// additional 4 storing the directory flag to determine whether it is directory or file
	return 1 + 4 + 4 + FileNameMaxLen + 4;
    }
    ...
    public void setDirectoryFlag(boolean i){
	directoryFlag = i;
    }
