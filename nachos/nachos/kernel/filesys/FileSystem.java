...
public abstract class FileSystem {
    ...
    public abstract void setCurrentDirectoryFile(OpenFile openFile);
	  
	  public abstract OpenFile getCurrentDirectoryFile();
	  
	  public abstract OpenFile getRootDirectoryFile();
    
    public abstract Map<String, OpenFile> getChildDirectoryMap();
    
    public abstract boolean createChild(String name, long initialSize, String directoryName);
    
    public abstract void moveToRoot();
    
    
    public abstract boolean moveToTheChildDirectory(String name);
    /**
     * Create a directory
     * @param name
     * @return
	...
	if(options.FILESYS_STUB)
	    ...
	    Debug.println('+', "Start using the real file system");
