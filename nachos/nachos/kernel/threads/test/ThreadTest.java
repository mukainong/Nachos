...
public class ThreadTest implements Runnable {
	...
	/*Uncomment the following statement if you want to run CyclicBarrier.demo()*/
	//CyclicBarrier.demo(null);
	
	/*Uncomment the following statement if you want to run TaskManager.demo()*/
	//TaskManager.demo(null);
